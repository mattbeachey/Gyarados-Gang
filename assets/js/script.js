function initProgram() {
  ...
  //Arrays
  const dogQuestions = [
    `	Have you ever used the snapchat dog filter and thought 'man, I wish I really did look this cute?'`,
  ...
  const arrayQuestions = [
    {
      questionNumber: 1,
      question:
        "You’re driving on the highway heading home to feed your dog. You’re about to miss your exit because your fave song came on the radio. What do you do next?",
      answerA: [
        "Seize the opportunity to cross over by cutting off a few cars, all while screaming the chorus to the song because you’re definitely not missing this exit. ",
        "adventurous"
      ],
      answerB: ["Wait for the next exit and reroute from there.", "rational"],
      answerC: [
        "Just keep driving because this song is fire. You’ll get home when you get home.",
        "mellow"
      ],
      answerD: [
        "Turn on your blinker, wave to the car next to you to let you in, and do that head nod/ wave thing like you’re best friends now.",
        "social"
      ],

      questionNumber: 2,
      question:
        "Your best friend’s mom made you some gross holiday cookies and wants to know how they were. What do you tell her?",
      answerA: [
        "Tell her they were great and thank her for the cookies.",
        "rational"
      ],
      answerB: ["Roast her. She deserves it.", "adventurous"],
      answerC: [
        "Thank her for the cookies and exchange recipes. Also use lots of baking terms to distract from the fact that you haven’t mentioned how they tasted.",
        "social"
      ],
      answerD: [
        "Give her a head nod and a thumbs up. Throw in a wink if they were especially awful.",
        "mellow"
      ],

      questionNumber: 3,
      question:
        "You’re eating a giant bowl of spaghetti in bed because you’re an adult and no one can tell you how to live your life. As you bring a huge bite up to your face you miss your mouth, spilling it all over your white comforter. What do you do now?",
      answerA: [
        "Instagram it, because “story of your life,” amirite?",
        "social"
      ],
      answerB: [
        "Break out the Oxi-Clean and curse yourself out the entire time you clean up your mess.",
        "rational"
      ],
      answerC: ["Scoop the bite up and keep eating.", "mellow"],
      answerD: [
        "Spread more sauce over your white comforter to create a tie dye effect. Add some sauce to your pillows too to create a cohesive bedding line.",
        "adventurous"
      ],

      questionNumber: 4,
      question:
        "Your friend is being dumb and wants to watch Bachelor In Paradise while you want to watch The Office for the 7 millionth time. How do you resolve this conflict?",
      answerA: [
        "Drink enough wine until you don’t care that you’re watching Bachelor In Paradise.",
        "mellow"
      ],
      answerB: [
        "Decide on a different show you both can enjoy together.",
        "rational"
      ],
      answerC: [
        "Smash the TV. Now no one gets to watch anything.",
        "adventurous"
      ],
      answerD: [
        "Smash the TV together, as friends. And talk to each other about the aggressive decision you both made over a cup of tea.",
        "social"
      ],

      questionNumber: 5,
      question:
        "It’s a hot and sweaty summer day and you decide to head over to the local public pool to cool off. The entire town is there and all of the lounge chairs are taken. What’s your sweaty body doing next?",
      answerA: [
        "Find a nice group and ask if you can share some space with them. You end up finding out you went to high school with one of them and now you’re feeling awkward and sweaty.",
        "social"
      ],
      answerB: [
        "Find a corner to set up camp and pop your headphones in. Enjoy the mist of pool water being splashed on you by the rowdy children.",
        "mellow"
      ],
      answerC: [
        "Go back to your car and sit in the air conditioning.",
        "rational"
      ],
      answerD: [
        "Throw a Snickers bar into the pool and wait for everyone to leave.",
        "adventurous"
      ],

      questionNumber: 6,
      question:
        "It’s a cold winter’s night and the wind howls through the open window like a pack of hungry wolves circling their prey. How do you keep warm?",
      answerA: ["Go deeper under the covers.", "mellow"],
      answerB: [
        "Get the book of matches from your bedside table and start a fire.",
        "adventurous"
      ],
      ...
      questionNumber: 7,
      question:
        "You've been tasked with digging a hole in the backyard. Do you:",
      answerA: ["Casually dig with a small spade.", "mellow"],
      answerB: [
        "Get a real shovel from the shed and start digging quickly and efficiently.",
        "rational"
      ],
      answerC: ["Call up some friends and have them dig with you", "social"],
      answerD: [
        "Get your face and paws....hands down by the ground and start making that hole any way you can.",
        "adventurous"
      ],
      ...
      answerC: [
        "Spend it all on adult beverages and snacks for your friends at the bar.",
        "social"
      ],
      answerD: [
        "Carefully spend it to travel across the world.",
        "adventurous"
      ],

      questionNumber: 9,
      question:
        "Your best friend has a poltergeist haunting her new place. She’s very scared. What do you do?",
      ...
      questionNumber: 10,
      question:
        "A former high school classmate invites you to join their pyramid scheme. Do you:",
      answerA: ["Say nothing.", "mellow"],
      answerB: ["Decline and explain why not.", "rational"],
      answerC: [
        "Agree and get more people to join the pyramid scheme.",
        "social"
      ],
      answerD: [
        "Decline and start your own pyramid scheme, making you millions.",
        "adventurous"
      ]
    }
  ];
